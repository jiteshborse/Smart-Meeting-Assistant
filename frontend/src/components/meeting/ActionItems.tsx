...
import { ScheduleFollowUp } from '../calendar/ScheduleFollowUp';
...
export const ActionItems: React.FC<ActionItemsProps> = ({
    ...
    const [schedulingItem, setSchedulingItem] = useState<ActionItem | null>(null);
    ...
    return (
        <>
            ...
            <ScheduleFollowUp
                ...
                meetingTitle={schedulingItem?.description}
                actionItem={schedulingItem ? {
                    description: schedulingItem.description,
                    assignee: schedulingItem.assignee || undefined
                } : undefined}
            />
        </>
    );
